...
### R-01 — Refuse: E7 causes exactly one fee, on Day 2
...
### R-02 — Refuse: E9 restores all balances and fees to pre-E7 values
...
### R-03 — Refuse: each BHD instalment is 3.334
...
### R-04 — Refuse: discard an interest rounding remainder
...
- The Day 2 pre-fee balance known at end of Day 5 is provisionally accepted: `AED 1,200.00 - AED 950.00 - AED 620.00 = AED -370.00`.
- Auth-A's settlement is provisionally accepted under the documented less-than-or-equal-to-hold resolution.
- Auth-Z's unknown-authorization settlement is rejected without moving funds.
- An approved hold affects available balance, not ledger balance; this conditional statement does not claim that Auth-B is approved in the stream.
