# Python assessment reference

This document describes the preserved Python implementation. Paths and commands below are relative to the repository root. For the canonical application on this branch, see [Ledger Lab](../README.md).
